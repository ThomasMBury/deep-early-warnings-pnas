...
def make_grid_figure(tsid, letter_label, title):
    ...
    # Get rate of forcing
    rof = df_properties[df_properties["tsid"] == tsid]["rate of forcing (mV/s)"].iloc[0]
...
for tsid in list_tsid:
    ...
    # Export as png
    fig.write_image(
        "../figures/fig_grid_ind/ind_figs_forced/img_{}_2.png".format(tsid), scale=2
    )
