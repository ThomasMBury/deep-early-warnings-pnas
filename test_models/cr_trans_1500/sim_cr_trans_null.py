...
# -*- coding: utf-8 -*-
"""
Created on Tue Mar 7 16:41:47 2020

@author: Thomas M. Bury

Simulate consumer-resource model 
Null simulations in Transcritical regime
Compute EWS
...
ah = 0.5*sf # control parameter final value
...
# Export individual residual files for DL algorithm
for i in np.arange(numSims)+1:
    df_resids = df_ews.loc[i,'x'].reset_index()[['Time','Residuals']]
    filepath='data/resids/cr_trans_null_1500_resids_{}.csv'.format(i)
