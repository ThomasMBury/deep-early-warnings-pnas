...
zf = zipfile.ZipFile('.# python code for training of machine learning algorithm, using keras library 
...
./training_data/output_full/ts_{}/combined/output_resids.zip'.format(ts_len))
text_files = zf.infolist()
sequences = list()
