...
# Note that decreasing lag-1 AC is expected prior to this Hopf
# so use *negative* kendall tau as the indicator
...
# Export ROC data
filepath = 'data/roc/df_roc_cr_hopf_{}.csv'.format(
    'early' if bool_pred_early else 'late')
...
fig.write_image('figures/roc_{}.png'.format('early' if bool_pred_early else 'late'))
