...
df_ml = pd.read_csv('../data/ml_preds/model_{}/parsed/df_ml_null.csv'.format(model500))
df_ml['Time'] = df_ml['Age']
df_ml = df_ml[df_ml['Null number']==null_number]

# Use 1500 ML prediction for tsid=3 (long)
df_ml_1500 = pd.read_csv('../data/ml_preds/model_{}/parsed/df_ml_null.csv'.format(model1500))
df_ml_1500['Time'] = df_ml_1500['Age']
df_ml_1500 = df_ml_1500[df_ml_1500['Null number']==null_number]
