...
Get ensemble predictions from len1500 DL classifiers for CR Hopf data
...
for var_label in var_labels[:1]:
    for tsid in tsid_vals[3:4]:
        ...
        dl_preds_mean.to_csv(
            f"data/ml_preds/ensemble_trend_probs_cr_hopf_forced_{var_label}_{tsid}.csv",
        )
...
#         # Export
#         dl_preds_mean.to_csv(
#             f"data/ml_preds/ensemble_trend_probs_cr_hopf_null_{var_label}_{tsid}.csv",
#         )
