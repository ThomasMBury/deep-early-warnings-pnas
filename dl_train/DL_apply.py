"""
####
Old version of dl_apply.py
Please use the dl_apply.py scripts within each model/empirical subdirectory
####
...
for model_type in [1, 2]:
    for kk in np.arange(1, 11):
        print("Compute DL predictions for model_type={}, kk={}".format(model_type, kk))
